...
export default function Page() {
  ...
  const interests = [
   ...
   { icon: "🎬", title: "Film & Shows", desc: "Whiplash is my favorite film. That should tell you something. I'm drawn to stories about people who go all in — and the cost of that." },
  ...
  const values = [
   { num: "01", title: "Depth over surface", desc: "Anyone can seem passionate. Real investment shows in the details — in knowing things others don't bother to know, in caring when no one's watching." },
   { num: "02", title: "Leading quietly", desc: "The best leaders don't announce themselves. They show up consistently, fully, and people naturally follow. That's the only kind of leadership worth having." },
   { num: "03", title: "Two selves, one person", desc: "I love people and I love solitude. I have the playlist everyone knows and the one only I listen to. Both are real. Neither is a mask." },
   { num: "04", title: "Compete with yourself first", desc: "The most honest competition isn't against others — it's against who you were yesterday. Win that one and the rest tends to follow." },
     ];
  ...
  return (
       <>
                                                     ...
                                                     body{background:var(--bg);color:var(--text);font-family:var(--fb);font-weight:300;line-height:1.7;overflow-x:hidden}
                                                             nav{position:fixed;top:0;left:0;right:0;z-index:100;padding:1.5rem 4rem;display:flex;justify-content:space-between;align-items:center;transition:background 0.4s}
                                                                     nav.scrolled{background:rgba(14,14,14,0.95);backdrop-filter:blur(12px);border-bottom:1px solid var(--border)}
                                                                             .nl{font-family:var(--fd);font-size:1.4rem;font-weight:300;letter-spacing:.05em;color:var(--text);text-decoration:none}
             ...
             <nav className={scrolled ? "scrolled" : ""}>
                     <a href="#" className="nl">Roey Halfon</a>a>
                     <ul className="nls">
                               <li><a href="#about">About</a>a></li>li>
                               <li><a href="#interests">Interests</a>a></li>li>
             ...
             <section className="hero">
                     <div className="hbg" />
                     <div className="hc">
                               <p className="htag">Based in Israel · 2026</p>p>
                               <h1 className="htitle">Roey<br /><em>Halfon</em>em></h1>h1>
                               <p className="hsub">Competitive. Passionate. A leader with a quiet inner world — someone who feels everything deeply and shows only what&apos;s needed.</p>p>
                               <a href="#about" className="hcta">Discover more →</a>a>
                     </div>div>
                     <span className="hscroll">Scroll to explore</span>span>
             </section>section>
             <section id="about">
                     <div className="about reveal">
                               <div>
                                           <p className="sl">Who I am</p>p>
                                           <h2 className="ah">Built on<br />passion &amp;<br /><em>discipline</em>em></h2>h2>
                                           <div className="as">
                                                         <div className="stat"><div className="sn">12th</div>div><div className="sl2">Grade</div>div></div>div>
                                                         <div className="stat"><div className="sn">5U</div>div><div className="sl2">Math</div>div></div>div>
                                                         <div className="stat"><div className="sn">∞</div>div><div className="sl2">Drive</div>div></div>div>
                                                         <div className="stat"><div className="sn">IL</div>div><div className="sl2">Israel</div>div></div>div>
                                           </div>div>
                               </div>div>
                               <div className="at">
                                           <p>I&apos;m Roey — a high school senior finishing my last chapter before the army. On the surface I&apos;m social, driven, and easy to be around. Underneath, there&apos;s a lot more going on.</p>p>
                                           <p>I study 5-unit mathematics — the hardest level — not because I have to, but because there&apos;s something deeply satisfying about working through problems that actually resist you.</p>p>
                                           <p>I&apos;m the kind of person who gets fully into things. Whether that&apos;s padel, gaming, a song I can&apos;t stop replaying, or a film that changes how I see something — I don&apos;t do things halfway.</p>p>
                                           <p>I believe in leading by how you carry yourself, not by announcing it. People tend to follow those who are genuinely invested, and I always am.</p>p>
                               </div>div>
                     </div>div>
             </section>section>
             <section id="interests">
                     <div style={{maxWidth:"1100px",margin:"0 auto"}}>
                               <p className="sl reveal">What drives me</p>p>
                               <div className="div" />
                               <div className="ig">
                                {interests.map((item, i) => (
                      <div key={i} className="ic reveal">
                                      <div className="ii">{item.icon}</div>div>
                                      <h3 className="it">{item.title}</h3>h3>
                                      <p className="id">{item.desc}</p>p>
                      </div>div>
                    ))}
                               </div>div>
                     </div>div>
             ...
             <section className="vs">
                     <div className="vi">
                               <h2 className="vh reveal">The things I<br />actually believe <em>in</em>em></h2>h2>
                               <div className="vl">
                                {values.map((v, i) => (
                      <div key={i} className="vitem reveal">
                                      <div className="vn">{v.num}</div>div>
                                      <div className="vt">{v.title}</div>div>
                                      <p className="vd">{v.desc}</p>p>
                      </div>div>
                    ))}
                               </div>div>
                     </div>div>
             ...
             <section id="contact">
                     <div className="ci reveal">
                               <p className="sl">Get in touch</p>p>
                               <h2 className="ch">Let&apos;s<br /><em>talk</em>em></h2>h2>
                               <p className="csub">Whether it&apos;s about padel, music, math, or something else entirely — I&apos;m always up for a real conversation.</p>p>
                               <a href="mailto:roeykhalfon@gmail.com" className="ce">roeykhalfon@gmail.com</a>a>
                     </div>div>
             </section>section>
             <footer>
                     <span>© 2026 Roey Halfon</span>span>
                     <span>Built with intention</span>span>
             </footer>footer>
       </>>
     );
}</>
